...
final class KnownField_ClassType_fields extends FieldDeclaration<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>, de.unistuttgart.iste.ps.skilled.sir.ClassType> implements
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.FieldLike> v = (java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.FieldLike>)((de.unistuttgart.iste.ps.skilled.sir.ClassType)data[i]).getFields();
            if(null==v || v.isEmpty())
                result++;
            else {
