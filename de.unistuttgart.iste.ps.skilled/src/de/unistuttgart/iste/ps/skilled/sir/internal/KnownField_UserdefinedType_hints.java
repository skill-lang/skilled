 ...
 */
final class KnownField_UserdefinedType_hints extends FieldDeclaration<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint>, de.unistuttgart.iste.ps.skilled.sir.UserdefinedType> implements
               KnownField<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint>, de.unistuttgart.iste.ps.skilled.sir.UserdefinedType> {

    public KnownField_UserdefinedType_hints(FieldType<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint>> type, int index, UserdefinedTypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.Hint> v = (java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.Hint>)((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType)data[i]).getHints();
            if(null==v || v.isEmpty())
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType)data[i]).getHints(), out);
        }
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType) ref).getHints();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType) ref).setHints(value);
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint> get(de.unistuttgart.iste.ps.skilled.sir.UserdefinedType ref) {
        return ref.getHints();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.UserdefinedType ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Hint> value) {
        ref.setHints(value);
    }
}
