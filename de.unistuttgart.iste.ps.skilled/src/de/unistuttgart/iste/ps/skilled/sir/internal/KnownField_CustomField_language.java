 ...
 */
final class KnownField_CustomField_language extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CustomField> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CustomField> {

    public KnownField_CustomField_language(FieldType<java.lang.String> type, int index, CustomFieldAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            String v = ((de.unistuttgart.iste.ps.skilled.sir.CustomField)data[i]).getLanguage();
            if(null==v)
                result++;
            else
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.CustomField)data[i]).getLanguage(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.CustomField) ref).getLanguage();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.CustomField) ref).setLanguage(value);
    }
