 ...
 */
final class KnownField_FieldLike_restrictions extends FieldDeclaration<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction>, de.unistuttgart.iste.ps.skilled.sir.FieldLike> implements
               KnownField<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction>, de.unistuttgart.iste.ps.skilled.sir.FieldLike> {

    public KnownField_FieldLike_restrictions(FieldType<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction>> type, int index, FieldLikeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.Restriction> v = (java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.Restriction>)(data[i]).getRestrictions();
            if(null==v || v.isEmpty())
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getRestrictions(), out);
        }
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.FieldLike) ref).getRestrictions();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.FieldLike) ref).setRestrictions(value);
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction> get(de.unistuttgart.iste.ps.skilled.sir.FieldLike ref) {
        return ref.getRestrictions();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.FieldLike ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.Restriction> value) {
