...
public class ClassType extends UserdefinedType {
    private static final long serialVersionUID = 0x5c11L + ((long) "classtype".hashCode()) << 32;
    ...
    /**
     * Create a new unmanaged ClassType. Allocation of objects without using the
    ...
    public String prettyString() {
        StringBuilder sb = new StringBuilder("ClassType(this: ").append(this);
     ...
     * @author Timm Felden
     */
    public static final class SubType extends ClassType implements NamedType {
