 ...
 */
final class KnownField_Tool_description extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Tool> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Tool> {

    public KnownField_Tool_description(FieldType<java.lang.String> type, int index, ToolAccess owner) {
        super(type, "description", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setDescription(sp.get(in.v64()));
        }
    }
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            String v = (data[i]).getDescription();
            if(null==v)
                result++;
            else
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getDescription(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Tool) ref).getDescription();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Tool) ref).setDescription(value);
    }
