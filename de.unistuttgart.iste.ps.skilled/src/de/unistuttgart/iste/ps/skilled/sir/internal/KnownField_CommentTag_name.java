 ...
 */
final class KnownField_CommentTag_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CommentTag> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CommentTag> {

    public KnownField_CommentTag_name(FieldType<java.lang.String> type, int index, CommentTagAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.CommentTag) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.CommentTag) ref).setName(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.CommentTag ref) {
        return ref.getName();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.CommentTag ref, java.lang.String value) {
        ref.setName(value);
    }
}
