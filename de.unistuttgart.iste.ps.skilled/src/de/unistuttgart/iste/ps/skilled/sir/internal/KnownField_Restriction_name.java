 ...
 */
final class KnownField_Restriction_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Restriction> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Restriction> {

    public KnownField_Restriction_name(FieldType<java.lang.String> type, int index, RestrictionAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Restriction) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Restriction) ref).setName(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.Restriction ref) {
        return ref.getName();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.Restriction ref, java.lang.String value) {
        ref.setName(value);
    }
}
