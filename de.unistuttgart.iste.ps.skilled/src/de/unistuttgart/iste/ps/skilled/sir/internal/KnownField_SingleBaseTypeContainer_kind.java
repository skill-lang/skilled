 ...
 */
final class KnownField_SingleBaseTypeContainer_kind extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer> {

    public KnownField_SingleBaseTypeContainer_kind(FieldType<java.lang.String> type, int index, SingleBaseTypeContainerAccess owner) {
        super(type, "kind", index, owner);
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            String v = ((de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer)data[i]).getKind();
            if(null==v)
                result++;
            else
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer)data[i]).getKind(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer) ref).getKind();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer) ref).setKind(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer ref) {
        return ref.getKind();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.SingleBaseTypeContainer ref, java.lang.String value) {
        ref.setKind(value);
    }
}
