 ...
 */
final class KnownField_BuildInformation_options extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.BuildInformation> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.BuildInformation> {

    public KnownField_BuildInformation_options(FieldType<java.util.ArrayList<java.lang.String>> type, int index, BuildInformationAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends java.lang.String> v = (java.util.ArrayList<? extends java.lang.String>)(data[i]).getOptions();
            if(null==v || v.isEmpty())
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getOptions(), out);
        }
    }

    @Override
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.BuildInformation) ref).getOptions();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.BuildInformation) ref).setOptions(value);
    }

    @Override
    public java.util.ArrayList<java.lang.String> get(de.unistuttgart.iste.ps.skilled.sir.BuildInformation ref) {
        return ref.getOptions();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.BuildInformation ref, java.util.ArrayList<java.lang.String> value) {
