 ...
 */
final class KnownField_InterfaceType_interfaces extends FieldDeclaration<java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType>, de.unistuttgart.iste.ps.skilled.sir.InterfaceType> implements
               KnownField<java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType>, de.unistuttgart.iste.ps.skilled.sir.InterfaceType> {

    public KnownField_InterfaceType_interfaces(FieldType<java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType>> type, int index, InterfaceTypeAccess owner) {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.InterfaceType)data[i]).getInterfaces(), out);
        }
    }

    @Override
    public java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.InterfaceType) ref).getInterfaces();
    }

    @Override
    public void setR(SkillObject ref, java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.InterfaceType) ref).setInterfaces(value);
    }

    @Override
    public java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType> get(de.unistuttgart.iste.ps.skilled.sir.InterfaceType ref) {
        return ref.getInterfaces();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.InterfaceType ref, java.util.HashSet<de.unistuttgart.iste.ps.skilled.sir.InterfaceType> value) {
