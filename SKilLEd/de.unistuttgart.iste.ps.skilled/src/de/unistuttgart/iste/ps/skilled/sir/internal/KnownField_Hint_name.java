 ...
 * string Hint.name
 */
final class KnownField_Hint_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Hint> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Hint> {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Hint) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Hint) ref).setName(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.Hint ref) {
        return ref.getName();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.Hint ref, java.lang.String value) {
        ref.setName(value);
    }
}
