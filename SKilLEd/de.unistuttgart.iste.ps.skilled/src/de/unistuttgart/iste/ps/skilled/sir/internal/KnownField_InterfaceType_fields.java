 ...
 */
final class KnownField_InterfaceType_fields extends FieldDeclaration<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>, de.unistuttgart.iste.ps.skilled.sir.InterfaceType> implements
               KnownField<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>, de.unistuttgart.iste.ps.skilled.sir.InterfaceType> {

    public KnownField_InterfaceType_fields(FieldType<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>> type, int index, InterfaceTypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.FieldLike> v = (java.util.ArrayList<? extends de.unistuttgart.iste.ps.skilled.sir.FieldLike>)((de.unistuttgart.iste.ps.skilled.sir.InterfaceType)data[i]).getFields();
            if(null==v || v.isEmpty())
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.InterfaceType)data[i]).getFields(), out);
        }
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.InterfaceType) ref).getFields();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.InterfaceType) ref).setFields(value);
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> get(de.unistuttgart.iste.ps.skilled.sir.InterfaceType ref) {
        return ref.getFields();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.InterfaceType ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> value) {
        ref.setFields(value);
    }
}
