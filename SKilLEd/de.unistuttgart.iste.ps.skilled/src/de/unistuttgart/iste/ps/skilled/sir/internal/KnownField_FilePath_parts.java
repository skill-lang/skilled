 ...
 */
final class KnownField_FilePath_parts extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.FilePath> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.FilePath> {

    public KnownField_FilePath_parts(FieldType<java.util.ArrayList<java.lang.String>> type, int index, FilePathAccess owner) {
    ...
    public long offset() {
        ...
        final de.unistuttgart.iste.ps.skilled.sir.FilePath[] data = ((FilePathAccess) owner.basePool()).data();
        long result = 0L;
        int i = null == range ? 0 : (int) range.bpo;
        final int high = null == range ? data.length : (int) (range.bpo + range.count);
        for (; i < high; i++) {
            final java.util.ArrayList<java.lang.String> v = (data[i]).getParts();
            if(null==v)
                result++;
            else {
    ...
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.FilePath) ref).getParts();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.FilePath) ref).setParts(value);
    }

    @Override
    public java.util.ArrayList<java.lang.String> get(de.unistuttgart.iste.ps.skilled.sir.FilePath ref) {
        return ref.getParts();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.FilePath ref, java.util.ArrayList<java.lang.String> value) {
        ref.setParts(value);
    }
}
