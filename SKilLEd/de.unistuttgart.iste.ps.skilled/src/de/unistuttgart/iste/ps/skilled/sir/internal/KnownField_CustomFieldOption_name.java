 ...
 */
final class KnownField_CustomFieldOption_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption> {

    public KnownField_CustomFieldOption_name(FieldType<java.lang.String> type, int index, CustomFieldOptionAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption) ref).setName(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption ref) {
        return ref.getName();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.CustomFieldOption ref, java.lang.String value) {
        ref.setName(value);
    }
}
