 ...
 */
final class KnownField_UserdefinedType_comment extends FieldDeclaration<de.unistuttgart.iste.ps.skilled.sir.Comment, de.unistuttgart.iste.ps.skilled.sir.UserdefinedType> implements
               KnownField<de.unistuttgart.iste.ps.skilled.sir.Comment, de.unistuttgart.iste.ps.skilled.sir.UserdefinedType> {

    public KnownField_UserdefinedType_comment(FieldType<de.unistuttgart.iste.ps.skilled.sir.Comment> type, int index, UserdefinedTypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final de.unistuttgart.iste.ps.skilled.sir.Comment instance = ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType)data[i]).getComment();
            if (null == instance) {
                result += 1;
                continue;
            }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            de.unistuttgart.iste.ps.skilled.sir.Comment v = ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType)data[i]).getComment();
            if (null == v)
                out.i8((byte) 0);
            else
    ...
    public de.unistuttgart.iste.ps.skilled.sir.Comment getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType) ref).getComment();
    }

    @Override
    public void setR(SkillObject ref, de.unistuttgart.iste.ps.skilled.sir.Comment value) {
        ((de.unistuttgart.iste.ps.skilled.sir.UserdefinedType) ref).setComment(value);
    }

    @Override
    public de.unistuttgart.iste.ps.skilled.sir.Comment get(de.unistuttgart.iste.ps.skilled.sir.UserdefinedType ref) {
        return ref.getComment();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.UserdefinedType ref, de.unistuttgart.iste.ps.skilled.sir.Comment value) {
