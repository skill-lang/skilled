 ...
 * string[] Comment.text
 */
final class KnownField_Comment_text extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.Comment> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.Comment> {

    public KnownField_Comment_text(FieldType<java.util.ArrayList<java.lang.String>> type, int index, CommentAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<? extends java.lang.String> v = (java.util.ArrayList<? extends java.lang.String>)(data[i]).getText();
            if(null==v || v.isEmpty())
                result++;
            else {
    ...
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Comment) ref).getText();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Comment) ref).setText(value);
    }

    @Override
    public java.util.ArrayList<java.lang.String> get(de.unistuttgart.iste.ps.skilled.sir.Comment ref) {
        return ref.getText();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.Comment ref, java.util.ArrayList<java.lang.String> value) {
        ref.setText(value);
    }
}
