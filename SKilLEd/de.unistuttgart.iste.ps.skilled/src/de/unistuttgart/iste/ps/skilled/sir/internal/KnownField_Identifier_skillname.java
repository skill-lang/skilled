 ...
 */
final class KnownField_Identifier_skillname extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Identifier> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skilled.sir.Identifier> {

    public KnownField_Identifier_skillname(FieldType<java.lang.String> type, int index, IdentifierAccess owner) {
        super(type, "skillname", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setSkillname(sp.get(in.v64()));
        }
    }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getSkillname(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Identifier) ref).getSkillname();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Identifier) ref).setSkillname(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skilled.sir.Identifier ref) {
        return ref.getSkillname();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.Identifier ref, java.lang.String value) {
        ref.setSkillname(value);
    }
}
