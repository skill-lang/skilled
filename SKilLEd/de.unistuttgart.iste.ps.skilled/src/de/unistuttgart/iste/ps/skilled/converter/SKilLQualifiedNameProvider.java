...
public class SKilLQualifiedNameProvider extends DefaultDeclarativeQualifiedNameProvider {
    ...
    QualifiedName qualifiedName(Fieldcontent field) {
        ...
        if (e == null) {
            QualifiedName q = QualifiedName.create(qualifiedNameConverter.makeEquivalent(field.getName()));
            return q;
        }
        d = (Declaration) e;
        QualifiedName q = QualifiedName.create(d.getName(), qualifiedNameConverter.makeEquivalent(field.getName()));
        return q;
    }
    ...
    QualifiedName qualifiedName(Enuminstance enuminstance) {
        ...
        if (e == null) {
            QualifiedName q = QualifiedName.create(qualifiedNameConverter.makeEquivalent(enuminstance.getName()));
            return q;
        }
        d = (Declaration) e;
        QualifiedName q = QualifiedName.create(d.getName(), qualifiedNameConverter.makeEquivalent(enuminstance.getName()));
        return q;
    }
}
