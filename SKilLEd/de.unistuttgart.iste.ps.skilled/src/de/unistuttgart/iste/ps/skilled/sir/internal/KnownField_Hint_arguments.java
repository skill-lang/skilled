 ...
 */
final class KnownField_Hint_arguments extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.Hint> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skilled.sir.Hint> {

    public KnownField_Hint_arguments(FieldType<java.util.ArrayList<java.lang.String>> type, int index, HintAccess owner) {
    ...
    public void read(ChunkEntry ce) {
        ...
        final Iterator<de.unistuttgart.iste.ps.skilled.sir.Hint> is;
    ...
    public long offset() {
        ...
        final de.unistuttgart.iste.ps.skilled.sir.Hint[] data = ((HintAccess) owner.basePool()).data();
        long result = 0L;
    ...
    public void write(MappedOutStream out) throws IOException {
        de.unistuttgart.iste.ps.skilled.sir.Hint[] data = ((HintAccess) owner.basePool()).data();
        int i;
        final int high;
    ...
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.Hint) ref).getArguments();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.Hint) ref).setArguments(value);
    }

    @Override
    public java.util.ArrayList<java.lang.String> get(de.unistuttgart.iste.ps.skilled.sir.Hint ref) {
        return ref.getArguments();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.Hint ref, java.util.ArrayList<java.lang.String> value) {
