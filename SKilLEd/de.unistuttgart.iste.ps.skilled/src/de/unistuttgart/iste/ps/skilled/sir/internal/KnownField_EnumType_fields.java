 ...
 */
final class KnownField_EnumType_fields extends FieldDeclaration<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>, de.unistuttgart.iste.ps.skilled.sir.EnumType> implements
               KnownField<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>, de.unistuttgart.iste.ps.skilled.sir.EnumType> {

    public KnownField_EnumType_fields(FieldType<java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike>> type, int index, EnumTypeAccess owner) {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skilled.sir.EnumType)data[i]).getFields(), out);
        }
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skilled.sir.EnumType) ref).getFields();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> value) {
        ((de.unistuttgart.iste.ps.skilled.sir.EnumType) ref).setFields(value);
    }

    @Override
    public java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> get(de.unistuttgart.iste.ps.skilled.sir.EnumType ref) {
        return ref.getFields();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skilled.sir.EnumType ref, java.util.ArrayList<de.unistuttgart.iste.ps.skilled.sir.FieldLike> value) {
        ref.setFields(value);
    }
}
