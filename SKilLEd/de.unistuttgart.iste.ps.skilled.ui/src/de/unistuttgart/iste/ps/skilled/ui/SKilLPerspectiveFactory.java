...
/**
 * Creates the initial SKilL Perspective Layout. It adds the Project Explorer,
 * Toolview, Problem View and Outline View. Additionally the shortcuts for
 * opening the views are added in the menus and also the shortcuts for creating
 * a SKilL Project and File.
 * 
 * @author Marco Link
 */
public class SKilLPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		outputfolder.addView("de.unistuttgart.iste.ps.skilled.ui.views.ToolView");
	...
	/**
	 * This will open the SKilL Perspective. It will be only opened, if it isn't
	 * already active and it won't be resetted.
	 */
