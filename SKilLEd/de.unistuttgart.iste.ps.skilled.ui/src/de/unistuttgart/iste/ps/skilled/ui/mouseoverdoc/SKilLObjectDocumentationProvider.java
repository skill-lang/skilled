...
/**
 * This Class defines the Object Documentation Provider for mouseover documentation in SKilL and 
 * creates the object documentation string for the documentation
 * 
...
public class SKilLObjectDocumentationProvider implements IEObjectDocumentationProvider {
	...
	public String getDocumentation(EObject o) {
		String returnString = "";
    	//binder.bind(String.class).annotatedWith(com.google.inject.name.Names.named((XtextContentAssistProcessor.COMPLETION_AUTO_ACTIVATION_CHARS))).toInstance(" \t" + eol);
     ...
     */
    String removeCommentMarkers(String s){
    	s = s.substring(2);
