...
/**
 * This class receives and saves tool name and path information from de.unistuttgart.iste.ps.skilled.ui.views.Toolview.java
 * and sends it to ExportTools.java
 * 
 * @author Leslie Tso
 *
 */
