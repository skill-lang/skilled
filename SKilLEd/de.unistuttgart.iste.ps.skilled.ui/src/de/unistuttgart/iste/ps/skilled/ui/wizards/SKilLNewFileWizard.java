 ...
 * "skill". If a sample multi-page editor (also available
...
public class SKilLNewFileWizard extends Wizard implements INewWizard {
	...
	private InputStream openContentStream() {
		String contents =
			"#This is a new amazing SKilL File" + "\n";
		return new ByteArrayInputStream(contents.getBytes());
	}

	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "de.unistuttgart.iste.ps.skilled.ui", IStatus.OK, message, null);
