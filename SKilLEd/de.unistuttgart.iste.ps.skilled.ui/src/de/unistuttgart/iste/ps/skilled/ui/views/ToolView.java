...
public class ToolView extends ViewPart {
    ...
    /**
     * Read the binary file of all the tools.
     */
        ...
        typeTree.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent arg0) {
                typeTree.addSelectionListener(new SelectionListener() {
                    ...
                    // listener to get the chosen type and build the proper fieldtree.
                    @Override
                    public void widgetSelected(SelectionEvent arg0) {
            ...
            public void mouseDoubleClick(MouseEvent arg0) {
                // TODO Open all the tempfiles used by the tool or the file in which the actual type/field is
        ...
        menu.addMenuListener(new MenuAdapter() {
            ...
            public void menuShown(MenuEvent e) {
                ...
                cloneToolItem.addSelectionListener(new SelectionListener() {
                    ...
                    @Override
                    public void widgetSelected(SelectionEvent arg0) {
                        // Create new tool with same content like the tool to copy from.
                ...
                renameToolItem.addSelectionListener(new SelectionListener() {
                    ...
                    @Override
                    public void widgetSelected(SelectionEvent arg0) {
                        createRenameOverlay(activeTool, toollist, selected);
                    }
    ...
    private void createRenameOverlay(Tool tool, List toollist, int selected) {
        ...
        buttonOk.addListener(SWT.MouseDown, new Listener() {
            @Override
            public void handleEvent(Event e) {
                activeTool.setName(first.getText());
                shell.close();
                toollist.remove(selected);
        ...
        buttonCancel.addListener(SWT.MouseDown, new Listener() {
