...
public class SKilLOrganizeImportsHandler {
	...
	/**
	 * Creates the includes for the main file, basically a index of all files in
	 * the project.
	 * 
	 * @param files The Set of all files
	 * @param mainFileURI The URI of the main file
	...
	/**
	 * Writes the new include in a file, closing it afterwards if it was not
	 * open to begin with.
	 * 
	 * @param file
