 ...
 * 
 * This field is used in the Quickfix for nonASCIICharWarnings. It opens a dialog to enter a new name for 
 * the Field or TypeDeclarationand changes the name to the entered name if the user clicks on the OK Button.
 *
 */
public class changeNameField{
	 ...
	 * @param s old Name of the Element
	 */
