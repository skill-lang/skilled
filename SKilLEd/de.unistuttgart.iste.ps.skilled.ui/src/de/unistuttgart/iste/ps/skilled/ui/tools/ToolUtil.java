...
public final class ToolUtil {
     ...
     * @param project the project containing tool
     ...
     * @param toolName name of the tool the type belongs to
     * @param project the project containing tool
     ...
     * @param toolName name of the tool the field-containing type belongs to
     * @param project the project containing tool
     ...
     * @param toolName the name of the tool
     * @param project the project containing tool
     * @param typeName the type name of the type containing the field
     ...
     * @param toolName the tool containing the type
     * @param project the project containing tool
     * @param typeName the type containing the hint
     * @param hintName the name of the hint to be added
     * @return true if adding was successful
     */
     ...
     * @param project the project containing tool
     * @param typeName the type containing the hint
     * @param hintName the name of the hint to be removed
     * @return true if removing was successful
     */
     ...
     * @param toolName the tool containing the field
     * @param project the project containing tool
     * @param typeName the type containing the field
     * @param fieldName the field containing the hint
     * @param hintName the name of the hint to be added
     * @return true if adding was successful
     */
     ...
     * @param toolName the name of the tool containing the hint
     * @param project the project containing tool
     * @param typeName the type containing the field
     * @param fieldName the field containing the hint
     * @param hintName the hint to be removed
     * @return True if removing was successful
     */
     ...
     * @param oldToolName the original name of the tool
     * @param newToolName the new name of the tool 
     * @param project the project containing tool
