 ...
 * string Type.comment
 */
final class KnownField_Type_comment extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Type> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Type> {

    public KnownField_Type_comment(FieldType<java.lang.String> type, int index, TypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            String v = ((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getComment();
            if(null==v)
                result++;
            else
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getComment(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).getComment();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).setComment(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skillls.tools.Type ref) {
        return ref.getComment();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skillls.tools.Type ref, java.lang.String value) {
