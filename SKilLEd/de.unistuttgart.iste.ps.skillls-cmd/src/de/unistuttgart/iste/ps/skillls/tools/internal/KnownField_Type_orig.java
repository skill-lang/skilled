 ...
 * type Type.orig
 */
final class KnownField_Type_orig extends FieldDeclaration<de.unistuttgart.iste.ps.skillls.tools.Type, de.unistuttgart.iste.ps.skillls.tools.Type> implements
               KnownField<de.unistuttgart.iste.ps.skillls.tools.Type, de.unistuttgart.iste.ps.skillls.tools.Type> {

    public KnownField_Type_orig(FieldType<de.unistuttgart.iste.ps.skillls.tools.Type> type, int index, TypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final de.unistuttgart.iste.ps.skillls.tools.Type instance = ((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getOrig();
            if (null == instance) {
                result += 1;
                continue;
            }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            de.unistuttgart.iste.ps.skillls.tools.Type v = ((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getOrig();
            if (null == v)
                out.i8((byte) 0);
            else
    ...
    public de.unistuttgart.iste.ps.skillls.tools.Type getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).getOrig();
    }

    @Override
    public void setR(SkillObject ref, de.unistuttgart.iste.ps.skillls.tools.Type value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).setOrig(value);
    }

    @Override
    public de.unistuttgart.iste.ps.skillls.tools.Type get(de.unistuttgart.iste.ps.skillls.tools.Type ref) {
        return ref.getOrig();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skillls.tools.Type ref, de.unistuttgart.iste.ps.skillls.tools.Type value) {
        ref.setOrig(value);
    }
}
