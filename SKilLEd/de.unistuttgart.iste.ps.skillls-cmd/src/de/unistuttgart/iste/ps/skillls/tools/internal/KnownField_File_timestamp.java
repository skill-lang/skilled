 ...
 */
final class KnownField_File_timestamp extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> {

    public KnownField_File_timestamp(FieldType<java.lang.String> type, int index, FileAccess owner) {
        super(type, "timestamp", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setTimestamp(sp.get(in.v64()));
        }
    }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getTimestamp(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.File) ref).getTimestamp();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.File) ref).setTimestamp(value);
    }
