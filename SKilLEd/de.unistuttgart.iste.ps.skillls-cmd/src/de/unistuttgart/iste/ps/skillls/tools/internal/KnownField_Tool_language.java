 ...
 */
final class KnownField_Tool_language extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> {

    public KnownField_Tool_language(FieldType<java.lang.String> type, int index, ToolAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).getLanguage();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).setLanguage(value);
    }
