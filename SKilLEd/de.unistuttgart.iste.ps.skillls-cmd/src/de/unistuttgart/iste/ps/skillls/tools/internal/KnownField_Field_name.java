 ...
 * string Field.name
 */
final class KnownField_Field_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Field> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Field> {

    public KnownField_Field_name(FieldType<java.lang.String> type, int index, FieldAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            String v = ((de.unistuttgart.iste.ps.skillls.tools.Field)data[i]).getName();
            if(null==v)
                result++;
            else
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skillls.tools.Field)data[i]).getName(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Field) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Field) ref).setName(value);
    }
