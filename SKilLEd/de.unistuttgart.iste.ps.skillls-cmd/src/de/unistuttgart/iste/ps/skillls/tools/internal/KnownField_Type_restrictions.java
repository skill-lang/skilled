 ...
 */
final class KnownField_Type_restrictions extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skillls.tools.Type> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skillls.tools.Type> {

    public KnownField_Type_restrictions(FieldType<java.util.ArrayList<java.lang.String>> type, int index, TypeAccess owner) {
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<java.lang.String> v = ((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getRestrictions();
            if(null==v)
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getRestrictions(), out);
        }
    }

    @Override
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).getRestrictions();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).setRestrictions(value);
    }
