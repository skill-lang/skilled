 ...
 * string Hint.name
 */
final class KnownField_Hint_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Hint> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Hint> {

    public KnownField_Hint_name(FieldType<java.lang.String> type, int index, HintAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Hint) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Hint) ref).setName(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skillls.tools.Hint ref) {
        return ref.getName();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skillls.tools.Hint ref, java.lang.String value) {
        ref.setName(value);
    }
}
