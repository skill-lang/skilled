 ...
 * string Tool.module
 */
final class KnownField_Tool_module extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> {

    public KnownField_Tool_module(FieldType<java.lang.String> type, int index, ToolAccess owner) {
        super(type, "module", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setModule(sp.get(in.v64()));
        }
    }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getModule(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).getModule();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).setModule(value);
    }
