 ...
 * string Tool.name
 */
final class KnownField_Tool_name extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> implements
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).getName();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).setName(value);
    }
