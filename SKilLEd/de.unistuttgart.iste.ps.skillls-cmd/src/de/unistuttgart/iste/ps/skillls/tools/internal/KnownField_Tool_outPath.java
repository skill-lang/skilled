 ...
 * string Tool.outPath
 */
final class KnownField_Tool_outPath extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Tool> {

    public KnownField_Tool_outPath(FieldType<java.lang.String> type, int index, ToolAccess owner) {
        super(type, "outpath", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setOutPath(sp.get(in.v64()));
        }
    }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getOutPath(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).getOutPath();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Tool) ref).setOutPath(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skillls.tools.Tool ref) {
        return ref.getOutPath();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skillls.tools.Tool ref, java.lang.String value) {
        ref.setOutPath(value);
    }
}
