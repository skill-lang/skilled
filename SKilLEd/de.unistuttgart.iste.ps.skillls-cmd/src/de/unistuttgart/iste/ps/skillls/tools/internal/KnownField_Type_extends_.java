 ...
 * string[] Type.extends
 */
final class KnownField_Type_extends_ extends FieldDeclaration<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skillls.tools.Type> implements
               KnownField<java.util.ArrayList<java.lang.String>, de.unistuttgart.iste.ps.skillls.tools.Type> {

    public KnownField_Type_extends_(FieldType<java.util.ArrayList<java.lang.String>> type, int index, TypeAccess owner) {
        super(type, "extends", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setExtends(type.readSingleField(in));
        }
    }
    ...
    public long offset() {
        ...
        for (; i < high; i++) {
            final java.util.ArrayList<java.lang.String> v = ((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getExtends();
            if(null==v)
                result++;
            else {
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(((de.unistuttgart.iste.ps.skillls.tools.Type)data[i]).getExtends(), out);
        }
    }

    @Override
    public java.util.ArrayList<java.lang.String> getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).getExtends();
    }

    @Override
    public void setR(SkillObject ref, java.util.ArrayList<java.lang.String> value) {
        ((de.unistuttgart.iste.ps.skillls.tools.Type) ref).setExtends(value);
    }

    @Override
    public java.util.ArrayList<java.lang.String> get(de.unistuttgart.iste.ps.skillls.tools.Type ref) {
        return ref.getExtends();
    }

    @Override
    public void set(de.unistuttgart.iste.ps.skillls.tools.Type ref, java.util.ArrayList<java.lang.String> value) {
        ref.setExtends(value);
    }
}
