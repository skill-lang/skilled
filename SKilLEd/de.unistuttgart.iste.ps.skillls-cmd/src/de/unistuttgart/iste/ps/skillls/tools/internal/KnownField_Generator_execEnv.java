...
/**
 * string Generator.execEnv
 */
final class KnownField_Generator_execEnv extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Generator> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.Generator> {

    public KnownField_Generator_execEnv(FieldType<java.lang.String> type, int index, GeneratorAccess owner) {
        super(type, "execenv", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setExecEnv(sp.get(in.v64()));
        }
    }
