 ...
 * string File.header
 */
final class KnownField_File_header extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> {

    public KnownField_File_header(FieldType<java.lang.String> type, int index, FileAccess owner) {
        super(type, "header", index, owner);
    ...
    public void read(ChunkEntry ce) {
        ...
        while (0 != count--) {
            is.next().setHeader(sp.get(in.v64()));
        }
    }
    ...
    public void write(MappedOutStream out) throws IOException {
        ...
        for (; i < high; i++) {
            type.writeSingleField(data[i].getHeader(), out);
        }
    }

    @Override
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.File) ref).getHeader();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.File) ref).setHeader(value);
    }

    @Override
    public java.lang.String get(de.unistuttgart.iste.ps.skillls.tools.File ref) {
        return ref.getHeader();
    }
