 ...
 * string File.path
 */
final class KnownField_File_path extends FieldDeclaration<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> implements
               KnownField<java.lang.String, de.unistuttgart.iste.ps.skillls.tools.File> {

    public KnownField_File_path(FieldType<java.lang.String> type, int index, FileAccess owner) {
    ...
    public java.lang.String getR(SkillObject ref) {
        return ((de.unistuttgart.iste.ps.skillls.tools.File) ref).getPath();
    }

    @Override
    public void setR(SkillObject ref, java.lang.String value) {
        ((de.unistuttgart.iste.ps.skillls.tools.File) ref).setPath(value);
    }
