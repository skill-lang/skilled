...
public class EditorIncorrectInputTest {
	...
	public void testCreateNewTool() {
		...
		try {
			...
			// File.separator + "IncorrectInput" + File.separator +
			// "DeleteToolNotExisting"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testDeleteToolNotExisting() {
		...
		try {
			SkillFile sk = SkillFile.open(skillFilePath, de.ust.skill.common.java.api.SkillFile.Mode.Read,
					de.ust.skill.common.java.api.SkillFile.Mode.Write);
			assertEquals("testTool not deleted. Failing ok, because not yet implemented in SKilL.", orig,
					sk.Tools().size());
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddTypeToNotExistingTool"),
	...
	public void testAddTypeToNotExistingTool() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddNotExistingType"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testAddNotExistingType() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "RemoveNotExistingType"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testRemoveNotExistingType() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddTypeWithoutExtension"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testAddTypeWithoutExtension() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddNotExistingField"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testAddNotExistingField() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddNotExistingFieldHint"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testRemoveNotExistingFieldHint() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "AddNotExistingTypeHint"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
	...
	public void testRemoveNotExistingTypeHint() {
		...
		try {
			...
			// Files.copy(Paths.get(skillFilePath), Paths.get("testFiles" +
			// File.separator + "IncorrectInput" + File.separator +
			// "RemoveNotExistingField"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
			fail();
		}
	}
