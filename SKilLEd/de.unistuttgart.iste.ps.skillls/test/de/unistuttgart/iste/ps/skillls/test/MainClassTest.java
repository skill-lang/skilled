...
public class MainClassTest {
    ...
    public void testGenerateTwoTypeToolWithLongParameters() {
        ...
        String[] args = new String[] { "--all", "--generator", builder, "--lang", "Java", "--output", "generated", "--exec",
                "scala", "--module", "twotypetool", "--path", "resources", "twoTypeTool" };
    ...
    public void testGenerateTwoTypeWithTypeHint() {
        ...
        args = new String[] { "-agloxmp", builder, "Java", "generated", "scala", "onetypetool", "resources", "oneTypeTool" };
        MainClass.main(args);
        assertTrue("not generated", Files.exists(Paths.get("generated" + File.separator + "java" + File.separator + "src"
    ...
    public void testGenerateAll() {
        ...
        String[] args = new String[] { "--all", "--generator", builder, "--lang", "Java", "--output", "generated", "--exec",
                "scala", "--module", "this.is.a.test", "--path", "resources" };
        MainClass.main(args);
    ...
    @SuppressWarnings({ "AssignmentToStaticFieldFromInstanceMethod", "static-method" })
    @Test
    ...
    public void testBreakage() {
        ...
        try {
            ...
            boolean correctMessage = message
                    .matches("The following tools are broken: +- (oneTypeTool|twoTypeTool) +- (oneTypeTool|twoTypeTool)");
    ...
    public void testReindexing() {
        ...
        } catch (@SuppressWarnings("unused") BreakageException e) {
            // ignored
        } catch (IOException e) {
            e.printStackTrace();
        }
