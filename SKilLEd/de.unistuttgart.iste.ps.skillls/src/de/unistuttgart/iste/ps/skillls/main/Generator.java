...
public class Generator implements Runnable {
     ...
     * @param tool the tool this instance should generate
     * @param project the path that contains the project.
     * @param completeCleanup variable deciding whether only the main or all temporary files should be deleted.
     ...
     * @throws IOException {@link Runtime#exec(String, String[], java.io.File)} or {@link BufferedReader#readLine()}
     ...
     * @throws IOException {@link Files#write(Path, byte[], OpenOption...)}
     */
