...
public class Generator implements Runnable {
     ...
     *            variable deciding whether only the main or all temporary files should be deleted.
     * @param command
     *            the command to be executed.
     * @param workingDirectory
     *            the working directory.
     */
    public Generator(Tool tool, String project, boolean completeCleanup, String command, java.io.File workingDirectory) {
        this.tool = tool;
     ...
     * 
     * @throws IOException
     *             throws same exception as {@link java.nio.file.Files#delete(Path)}
     */
     ...
     * 
     * @throws IOException
     *             {@link Runtime#exec(String, String[], java.io.File)} or {@link BufferedReader#readLine()}
     * @throws InterruptedException
     *             throws exception at the same time as {@link Process#waitFor()}
     */
     ...
     * 
     * @throws IOException
     *             throws exception at the same time as {@link Files#createDirectories(Path, FileAttribute[])}
     */
    ...
    /**
     * Runs the generation as an extra thread (if executed with {@link Thread#start()}
     */
    @Override
    public void run() {
        try {
